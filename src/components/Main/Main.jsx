...
const Main = () => {
  const prompt1 = "What is Autodesk?";
  const prompt2 = "ML and Autodesk";
  const prompt3 = "What is AutoCad";
  const prompt4 = "When was Autodesk formed?";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to the Autodesk ChatBot</p>
          </div>
          <div className="cards">
